...
namespace Agent_LCU
{
    ...
    public partial class Program
    {
        ...
        public static CommonQuery_forSMD comQryLCU_forSMD = new CommonQuery_forSMD();
        ...
        static void Main(string[] args)
        {
            ...
            switch (args.Length)
            {
                ...
                case 3:
                    break;
                default:
                    Console.WriteLine("用法:LCU_TERAOKA_LCU_1 SMD的區域 裝置 指定檔案 \n"
                                     + "範例:LCU_TERAOKA_LCU_1 \"PC4LCU700\" \"LCU1\" \"15\" ");
            ...
            using (Mutex m = new Mutex(false, "Global\\" + appGuid))
            {
                ...
                using (Mutex m2 = new Mutex(false, "Global\\" + appGuidExe + "^" + args[1]))
                {
                    ...
                    {
                        //FTP測試連線
                        comQryLCU_forSMD.FTP_TryConnection(ref ftpclient);
