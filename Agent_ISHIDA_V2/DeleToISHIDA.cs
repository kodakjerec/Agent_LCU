    ...
    class DeleToISHIDA
    {
        ...
        public string MainFunction(string ORDER_TYPE, string GUID)
        {
            ...
            if (ORDER_TYPE == "115")
            {
                ...
                dt_Inbound_ISHIDA_TXT = Program.comQryISHIDA.GetTxtFromISHIDA_V2(ref delFileName, ref GUID);
            }
            else
            {
                dt_Inbound_ISHIDA_TXT = Program.comQryISHIDA.GetTxtFromISHIDA_V2(ref TXTfile_KeyValue, ref GUID);
            }
